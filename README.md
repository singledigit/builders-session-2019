...
This is a sample template for gw - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name gw --tail
```
...
```bash
aws cloudformation delete-stack --stack-name gw
```
